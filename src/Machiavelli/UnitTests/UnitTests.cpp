...
namespace UnitTests
{
    ...
    private:
        ...
        const static bool uciFormat = true;
    ...
    public:
        TEST_METHOD(Position1)
        {
            ...
            Assert::AreEqual(197281, gen1.Perft(4, printInfo, uciFormat));
        }
        ...
        TEST_METHOD(Position2)
        {
            ...
            Assert::AreEqual(4085603, gen2.Perft(4, printInfo, uciFormat));
        }
        ...
        TEST_METHOD(Position3)
        {
            ...
            Assert::AreEqual(43238, gen3.Perft(4, printInfo, uciFormat));
        }
        ...
        TEST_METHOD(Position4)
        {
            ...
            Assert::AreEqual(422333, gen4.Perft(4, printInfo, uciFormat));
        }
        ...
        TEST_METHOD(Position5)
        {
            ...
            Assert::AreEqual(2103487, gen5.Perft(4, printInfo, uciFormat));
        }
        ...
        TEST_METHOD(Position6)
        {
            ...
            Assert::AreEqual(3894594, gen6.Perft(4, printInfo, uciFormat));
        }
    };
